...
const DygoLogoAuth: React.FC<{ className?: string }> = ({ className = "w-32 h-32 text-white" }) => (
...
const AuthScreen: React.FC<AuthScreenProps> = ({ onAuthSuccess }) => {
        ...
        const handleSupabaseCallback = async () => {
            ...
            try {
                ...
                try {
                    ...
                    console.log('📤 Llamando a onAuthSuccess con usuario (verificando términos)...');
    ...
    // T&C modal — shown after auth if first time
        ...
        return (
            <TermsAndConditionsModal
                ...
                onDecline={() => {
                    setShowTerms(false);
                    setPendingUser(null);
                    authCallbackExecutedRef.current = false;
                    setError('Debes aceptar los Términos y Condiciones para acceder a mainds.');
                }}
            />
        );
    }
            ...
            <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-slate-100 flex items-center justify-center p-4">
                <div className="text-center">
                    <div className="mb-2 flex justify-center">
                        <DygoLogoAuth className="w-32 h-32 text-indigo-600" />
                    </div>
                    <h1 className="text-4xl font-bold text-indigo-600 tracking-tight mb-4 font-dygo">mainds</h1>
        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-slate-100 flex items-center justify-center p-4 relative">
            ...
            <div className="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden flex flex-col">
                <div className="bg-indigo-600 p-8 text-center flex flex-col items-center relative overflow-hidden">
                    ...
                    <h1 className="text-4xl font-bold text-white tracking-tight mb-1 -mt-3 font-dygo relative z-10">mainds</h1>
