...
// Custom Mainds Logo Component for Auth
const MaindsLogoAuth: React.FC<{ className?: string }> = ({ className = "w-32 h-32 text-white" }) => (
            ...
            <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-slate-100 flex items-center justify-center p-4">
                <div className="text-center">
                    <div className="mb-2 flex justify-center">
                        <MaindsLogoAuth className="w-32 h-32 text-indigo-600" />
                    </div>
        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-slate-100 flex items-center justify-center p-4 relative">
            ...
            <div className="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden flex flex-col">
                ...
                <div className="bg-indigo-600 p-8 text-center flex flex-col items-center relative overflow-hidden">
                    ...
                    <h1 className="text-4xl font-bold text-white tracking-tight mb-1 -mt-3 font-mainds relative z-10">mainds</h1>
