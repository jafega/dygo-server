...
import { Users, FileText, User as UserIcon, Calendar, Menu, X, ArrowLeftRight, ShieldCheck, Link2, BarChart3, AlertCircle, ClipboardList, Building2, Scroll } from 'lucide-react';
...
interface PsychologistSidebarProps {
  activeView: 'patients' | 'billing' | 'profile' | 'dashboard' | 'sessions' | 'schedule' | 'centros' | 'templates';
  onViewChange: (view: 'patients' | 'billing' | 'profile' | 'dashboard' | 'sessions' | 'schedule' | 'centros' | 'templates') => void;
  isOpen: boolean;
  onToggle: () => void;
  userName?: string;
  userEmail?: string;
