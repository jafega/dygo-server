...
const PsychologistSidebar: React.FC<PsychologistSidebarProps> = ({ 
  ...
  const handleUpgrade = async () => {
    ...
    try {
      ...
      if (resp?.url) {
        localStorage.setItem('mainds_stripe_return_panel', 'schedule');
        ...
        <div className="p-4 border-b border-slate-200">
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mainds text-xl font-bold text-slate-900">mainds <span className="text-purple-600">pro</span></span>
            </div>
