...
const CentrosPanel = forwardRef<CentrosPanelRef, CentrosPanelProps>(({ psychologistId, canCreate = true, onNeedUpgrade }, ref) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingCentro) {
        ...
        const response = await apiFetch(`${API_URL}/centers/${editingCentro.id}`, {
          method: 'PATCH',
        ...
        // Create new center
        const response = await apiFetch(`${API_URL}/centers`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            ...formData,
  ...
  const handleDelete = async (centroId: string) => {
    ...
    try {
      const response = await apiFetch(`${API_URL}/centers/${centroId}?psychologistId=${psychologistId}`, {
        method: 'DELETE'
      });
