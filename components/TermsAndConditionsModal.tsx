            ...
            <div className="bg-white w-full max-w-3xl rounded-2xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden">
                ...
                >
                    ...
                    <section>
                        ...
                        <p className="mt-2">
                            La Empresa es titular y operadora de la plataforma de software como servicio denominada <strong>mainds</strong> (anteriormente conocida como «dygo»), accesible a través de los dominios, subdominios y aplicaciones móviles que la Empresa designe en cada momento (en adelante, la «<strong>Plataforma</strong>»).
                        </p>
                        <p className="mt-2">
