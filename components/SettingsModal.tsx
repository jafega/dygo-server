...
const SettingsModal: React.FC<SettingsModalProps> = ({ settings, onSave, onClose, onLogout, onUserUpdate }) => {
  ...
  return (
    <>
    <div className={`fixed top-0 left-0 w-screen h-[100dvh] bg-slate-900/50 flex items-center justify-center z-[9999] p-4 backdrop-blur-sm${showUpgradeModal ? ' invisible' : ''}`} onClick={onClose}>
