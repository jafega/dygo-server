...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (stripeParam === 'success') {
      ...
      localStorage.removeItem('dygo_stripe_return_panel');
      // Mark in sessionStorage so components can detect Stripe return even after first render
      sessionStorage.setItem('dygo_stripe_return', '1');
      ...
      const syncAndRefresh = async () => {
        try {
          ...
          window.dispatchEvent(new CustomEvent('dygo:stripe-synced'));
        } catch (_) {}
      };
          ...
          <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-indigo-50 to-slate-100 p-4">
              <div className="text-center">
                  <div className="mb-6 flex justify-center">
                      <DygoLogo className="w-24 h-24 text-indigo-600 animate-pulse" />
                  </div>
          ...
          <div className="p-4 border-b border-slate-200">
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-dygo text-xl font-bold text-slate-900">mainds</span>
              </div>
